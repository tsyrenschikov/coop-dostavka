...
/*---widget sub categories---*/
    ...
    /*---widget sub categories---*/
    $(".sub_categories37 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories37').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories38 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories38').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories39 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories39').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories40 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories40').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories41 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories41').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories42 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories42').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories43 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories43').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories44 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories44').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories45 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories45').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories46 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories46').slideToggle('medium');
    });

    /*---widget sub categories---*/
    $(".sub_categories47 > a").on("click", function() {
        $(this).toggleClass('active');
        $('.dropdown_categories47').slideToggle('medium');
    });
