...
urlpatterns = [
    ...
    path('change_password/', PasswordChangeView.as_view(template_name='panel/change_password.html'),name='change_password'),
    path('change_password_done/', views.PasswordChangeDoneView,name='change_password_done'),
