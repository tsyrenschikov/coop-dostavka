...
class files(models.Model):
    ...
    slug = models.SlugField(max_length=200, null=True, db_index=True, verbose_name='Магазин')
    fileart = models.FileField(upload_to='file_upload/', blank=True, null=True, verbose_name='Файл выгрузки товаров')
...
class rezh(models.Model):
    ...
    image1 = models.ImageField(upload_to='rezh/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='rezh/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='rezh/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class arti(models.Model):
    ...
    image1 = models.ImageField(upload_to='arti/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='arti/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='arti/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class artiobschepit(models.Model):
    ...
    image1 = models.ImageField(upload_to='artiobschepit/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='artiobschepit/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='artiobschepit/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class bogdan(models.Model):
    ...
    image1 = models.ImageField(upload_to='bogdan/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='bogdan/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='bogdan/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class chetkarino(models.Model):
    ...
    name = models.CharField(max_length=200, db_index=True, verbose_name='Название продукта')
    artikul = models.CharField(max_length=500, db_index=True, null=True, verbose_name='Артикул')
    image = models.ImageField(upload_to='chetkarino/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение')
    image1 = models.ImageField(upload_to='chetkarino/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='chetkarino/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='chetkarino/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class zajkovskoe(models.Model):
    ...
    image1 = models.ImageField(upload_to='zajkovskoe/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='zajkovskoe/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='zajkovskoe/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class pokrovskoe(models.Model):
    ...
    image1 = models.ImageField(upload_to='pokrovskoe/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='pokrovskoe/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='pokrovskoe/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class krasnoufimsk(models.Model):
    ...
    image1 = models.ImageField(upload_to='krasnoufimsk/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='krasnoufimsk/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='krasnoufimsk/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class bugalysh(models.Model):
    ...
    image1 = models.ImageField(upload_to='bugalysh/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='bugalysh/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='bugalysh/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class chernovskoe(models.Model):
    ...
    image1 = models.ImageField(upload_to='chernovskoe/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='chernovskoe/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='chernovskoe/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class bisert(models.Model):
    ...
    image1 = models.ImageField(upload_to='bisert/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='bisert/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='bisert/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class natalinsk(models.Model):
    ...
    image1 = models.ImageField(upload_to='natalinsk/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='natalinsk/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='natalinsk/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
...
class oblpotrebsoyuz(models.Model):
    shop = models.ForeignKey(Shop, on_delete=models.CASCADE, null=True, verbose_name='Магазин')
    name = models.CharField(max_length=200, db_index=True, verbose_name='Название продукта')
    artikul = models.CharField(max_length=500, db_index=True, null=True, verbose_name='Артикул')
    image = models.ImageField(upload_to='oblpotrebsoyuz/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение')
    image1 = models.ImageField(upload_to='oblpotrebsoyuz/1/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение1')
    image2 = models.ImageField(upload_to='oblpotrebsoyuz/2/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение2')
    image3 = models.ImageField(upload_to='oblpotrebsoyuz/3/%Y/%m/%d', blank=True, null=True, verbose_name='Изображение3')
    description = models.TextField(blank=True, verbose_name='Описания продукта')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Цена')
    discount = models.DecimalField(max_digits=10, decimal_places=2, null=True, verbose_name='Скидка')
    categ = models.CharField(max_length=200, db_index=True, null=True, verbose_name='Категория продукта')
