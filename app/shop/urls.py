...
# Shop artiobschepit
    ...
    path('arti/artiobschepit/searchproduct/', views.searchproduct_art, name='searchproduct_artiob'),
...
# Shop artiprom
    ...
    path('arti/arti_p/searchproduct/', views.searchproduct_arti_p, name='searchproduct_arti_p'),
    ...
    path('zajkovskoe/searchproduct/', views.searchproduct, name='searchproduct'),
    ...
    path('pokrovskoe/searchproduct/', views.searchproduct, name='searchproduct'),
...
# Shop bogdan
    ...
    path('bogdan/searchproduct/', views.searchproduct, name='searchproduct'),
    ...
    path('rezh/searchproduct/', views.searchproduct, name='searchproduct'),
    ...
    path('chetkarino/searchproduct/', views.searchproduct, name='searchproduct'),
...
# Shop bugalysh
    ...
    path('bugalysh/searchproduct/', views.searchproduct, name='searchproduct'),
...
# Shop bisert
    ...
    path('bisert/searchproduct/', views.searchproduct, name='searchproduct'),
...
#Shop chernovskoe
    ...
    path('chernovskoe/searchproduct/', views.searchproduct, name='searchproduct'),
...
#Shop natalinsk
    ...
    path('natalinsk/searchproduct/', views.searchproduct, name='searchproduct'),
