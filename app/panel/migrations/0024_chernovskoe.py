# Generated by Django 4.0.3 on 2022-10-25 15:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('panel', '0023_remove_helpdesk_user_date_remove_helpdesk_user_time_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='chernovskoe/%Y/%m/%d', verbose_name='Изображение')),
