...
var Slinky = function () {
    ...
    return _createClass(n, [{
        ...
        key: "_addListeners", value: function () {
            var n = this, i = this.menu, s = this.settings;
        ...
        key: "_move", value: function () {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0, t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : function () {
            };
            if (0 !== e) {
                var n = this.settings, i = this.base, s = Math.round(parseInt(i.get(0).style.left)) || 0;
        ...
        key: "_transition", value: function () {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 300, t = this.menu, n = this.base;
        ...
        key: "jump", value: function (e) {
            var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1];
            if (e) {
                var n = this.menu, i = this.settings, s = jQuery(e), a = n.find(".active"), r = 0;
        ...
        key: "home", value: function () {
            var e = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0], t = this.base, n = this.menu, i = this.settings;
            e || this._transition(0);
            var s = n.find(".active"), a = s.parentsUntil(n, "ul");
        ...
        key: "destroy", value: function () {
            var t = this, e = this.base, n = this.menu;
            jQuery(".header", n).remove(), jQuery("a", n).removeClass("next").off("click"), n.css({height: "", "transition-duration": ""}), e.css({
                left: "",
                "transition-duration": ""
